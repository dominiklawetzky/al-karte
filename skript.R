...
karte <- data.frame(ort = c("Taunusstein", "Niedernhausen", "Idstein", "Bad Camberg", "Hadamar", "Limburg", "Hünstetten", "Hohenstein", "Heidenrod", "Lorch", "Rüdesheim", "Eltville", "Walluf", "Bad Schwalbach"),
                    lng = c(taunusstein$lng, niedernhausen$lng, idstein$lng, badcamberg$lng, hadamar$lng, limburg$lng, huenstetten$lng, hohenstein$lng, heidenrod$lng, lorch$lng, ruedesheim$lng, eltville$lng, walluf$lng, badschwalbach$lng),
                    lat = c(taunusstein$lat, niedernhausen$lat, idstein$lat, badcamberg$lat, hadamar$lat, limburg$lat, huenstetten$lat, hohenstein$lat, heidenrod$lat, lorch$lat, ruedesheim$lat, eltville$lat, walluf$lat, badschwalbach$lat))
